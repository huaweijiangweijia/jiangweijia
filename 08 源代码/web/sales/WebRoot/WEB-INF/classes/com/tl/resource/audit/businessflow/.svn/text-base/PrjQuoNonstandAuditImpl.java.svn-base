...
public class PrjQuoNonstandAuditImpl implements IAuditBusinessObject ,IAuditContentBusinessObject {

	private ProjectQuoService projectQuoService = (ProjectQuoService) SystemInstance.getInstance().getBean("ProjectQuoService");
	...
	private String businessType = "013";
	@Override
	public String cancelAudit() {
		// TODO Auto-generated method stub
		return projectQuoService.cancelAudit(abo.getBusinessId());
	}

	@Override
	public String endAudit() {
		// TODO Auto-generated method stub
		return projectQuoService.endAudit(abo.getBusinessId());
	}
	
	@Override
	public String submitAudit() {
		// TODO Auto-generated method stub
		return projectQuoService.submitAudit(abo.getBusinessId());
	}
	...
	public String getUrl() {
		// TODO Auto-generated method stub
		return "/js/quotation/projectQuo/proQuoDetailWindow.js";
	}
	...
	public void loadBo(String id) {
		...
		TQuotationInfor vo = projectQuoService.getQuoInfoByID(id);
		bo.setId(vo.getId());
		...
		bo.addProperty("url", "/js/quotation/projectQuo/proQuoDetailWindow.js");
	}
	...
	public List<TAuditContentDefDto> getBusinessAuditContents(String id) {
		boolean change = projectQuoService.isPriceChange(id);
		List<TAuditContentDefDto> list = auditContentService.findAllAuditContentList();
		if(change) return list;
		for (Iterator iterator = list.iterator(); iterator.hasNext();) {
			TAuditContentDefDto auditContentDefDto = (TAuditContentDefDto) iterator
					.next();
			if(PRICE.equals(auditContentDefDto.getId())){
				list.remove(auditContentDefDto);
				break;
			}
		}
		return list;
