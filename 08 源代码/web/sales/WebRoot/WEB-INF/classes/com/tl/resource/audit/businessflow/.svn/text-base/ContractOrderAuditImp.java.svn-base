...
public class ContractOrderAuditImp  implements IAuditBusinessObject{
	...
	private String businessType = "005";
	@Override
	public String cancelAudit() {
		// TODO Auto-generated method stub
		return contractOrderService.cancelAudit(abo.getBusinessId());
	}

	@Override
	public String endAudit() {
		// TODO Auto-generated method stub
		return contractOrderService.endAudit(abo.getBusinessId());
	}
	
	@Override
	public String submitAudit() {
		// TODO Auto-generated method stub
		return contractOrderService.submitAudit(abo.getBusinessId());
	}
...
//		list.add(phi8);
	...
	public void loadBo(String id) {
		...
		TOrderInfor vo = contractOrderService.getOrderInforById(id);
		bo.setId(vo.getId());
		...
		bo.addProperty("url", "/js/contractOrder/addContractOrder.js");
	}
