...
public class TestCutQuoAuditImpl implements IAuditBusinessObject,IAuditContentBusinessObject {
	...
	private String businessType = "015";
	@Override
	...
	public String getUrl() {
		// TODO Auto-generated method stub
		return "/js/quotation/testCutQuo/QuoDetailWindow.js";
	}
	...
	public void loadBo(String id) {
		...
		bo.addProperty("url", "/js/quotation/testCutQuo/QuoDetailWindow.js");
	}
