...
public class ScheduleOrderAuditImp implements IAuditBusinessObject{
	...
	private String businessType = "008";
	@Override
	public String cancelAudit() {
		// TODO Auto-generated method stub
		return scheduleOrderService.cancelAudit(abo.getBusinessId());
	}

	@Override
	public String endAudit() {
		// TODO Auto-generated method stub
		return scheduleOrderService.endAudit(abo.getBusinessId());
	}
	
	@Override
	public String submitAudit() {
		// TODO Auto-generated method stub
		return scheduleOrderService.submitAudit(abo.getBusinessId());
	}
...
//		list.add(phi8);
	...
	public void loadBo(String id) {
		...
		TOrderInfor vo = scheduleOrderService.getOrderInforById(id);
		bo.setId(vo.getId());
		...
		bo.addProperty("url", "/js/scheduleOrder/addScheduleOrder.js");
	}
