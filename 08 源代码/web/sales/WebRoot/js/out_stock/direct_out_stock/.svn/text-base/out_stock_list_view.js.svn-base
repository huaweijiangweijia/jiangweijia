...
var  selectForm3 = new Ext.FormPanel({
                        ...
                        items:[
                            ...
                            items:[
                                {columnWidth:0.25,items: [{xtype:'textfield',fieldLabel: '出库单编号',name: 'outStockCode',anchor:'90%'}]},	
                                {columnWidth:0.25,items: [new Ext.ffc.OutStockStatusComboBox({anchor:'60%'})]},
                                {columnWidth:0.15,items: [{xtype:'datefield',fieldLabel: '编制日期',name: 'startDate',anchor:'100%', format:'Y-m-d'}]},
								{columnWidth:0.25,items: [{xtype:'datefield',fieldLabel: '至',name: 'endDate',anchor:'60%', format:'Y-m-d'}]}
                                ]
                            }
                        ],//items
