...
var  qsOProductSelectForm = Ext.extend(Ext.FormPanel, {
	store:null,
	quotationCode:null,
	constructor : function(_cfg) {
		...
		this.store.load();
		qsOProductSelectForm.superclass.constructor.call(this, {
	...
	var qsOProductTree = Ext.extend(Ext.tree.ColumnTree,{
		quotationCode:null,
		supplierId:null,
		store:null,
		constructor : function(_cfg){
			...
			qsOProductTree.superclass.constructor.call(this, {
				height: 470,
				bodyStyle:'width:100%',
				rootVisible:false,
				autoScroll:true,
...
//					{header:'ID',width:0,dataIndex:'id',hidden : true
					{header:'报价单详细ID',width:100,dataIndex:'contractProductDetailId',disEnableEdit:true},
	...
	var qsOProdcutPanel = Ext.extend(Ext.Panel,{
		selectForm2:null,
		detail_list:null,
		quotationCode:null,
		supplierId:null,
		constructor : function(_cfg){
			...
			Ext.apply(this, _cfg);
			this.selectForm2 = new qsOProductSelectForm({quotationCode:this.quotationCode});
			this.detail_list = new qsOProductTree({quotationCode:this.quotationCode,supplierId:this.supplierId});
			qsOProdcutPanel.superclass.constructor.call(this, {
			iconCls:'icon-grid',
            layout: 'border',
			width: 250,
			height : 500,
	...
	var qsOProductWin = Ext.extend(Ext.Window,{
		nav2:null,
		quotationCode:null,
		supplierId:null,
		callBackMethod:null,
		constructor : function(_cfg){
			...
			Ext.apply(this, _cfg);
			this.nav2 = new qsOProdcutPanel({quotationCode:this.quotationCode,supplierId:this.supplierId});
...
//					}
//				},this);
			qsOProductWin.superclass.constructor.call(this, {
				title:"添加产品",  
				width:850,  
				height:544,  
//				modal:true,
