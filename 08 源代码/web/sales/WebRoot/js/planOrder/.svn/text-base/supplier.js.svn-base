	...
	var pOSupplerGrid = Ext.extend(Ext.grid.GridPanel,{
		constructor : function(_cfg){
			if(_cfg == null) {
				_cfg = {};
			}
			Ext.apply(this, _cfg);
			var proxy = new Ext.data.HttpProxy({url: PATH + "/planOrder/suppliersInforList.do"});
			...
			pOSupplerGrid.superclass.constructor.call(this, {
				height:500,
				store: store,
				columns: [
					...
					{header: "供货商名称",dataIndex:'supplierName',width: 230,sortable:true,renderer:function(value, cellmeta, record, rowIndex, columnIndex, store){return '<span>' + value + "</span>";}},
...
var  pOSupplierSelectForm = Ext.extend(Ext.FormPanel, {
	constructor : function(_cfg) {
		if(_cfg == null) {
			_cfg = {};
		}
		Ext.apply(this, _cfg);
		pOSupplierSelectForm.superclass.constructor.call(this, {
	...
	var pOsupplierWin = Ext.extend(Ext.Window,{
		supplier_grid:null,
		selectForm2:null,
		constructor : function(_cfg){
			if(_cfg == null) {
			...
			Ext.apply(this, _cfg);
			this.selectForm2 = new pOSupplierSelectForm();
			this.supplier_grid = new pOSupplerGrid();
			...
			pOsupplierWin.superclass.constructor.call(this, {
