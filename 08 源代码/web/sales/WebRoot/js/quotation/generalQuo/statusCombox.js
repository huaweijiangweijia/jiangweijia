 ...
 * 生产计划状态(1编制中，2已发布)
 */
Ext.ffc.ProductionPlanStatusComboBox = Ext.extend(Ext.form.ComboBox, {
			store : null,
			constructor : function(_cfg) {
				if (_cfg == null) {
					_cfg = {};
				...
				this.store = new Ext.data.SimpleStore({
							fields : ['planStatus', 'planStatusText'],
							data : [[-1, '全部'], [1, '编制中'], [2, '已发布']]
						});
				Ext.ffc.ProductionPlanStatusComboBox.superclass.constructor.call(
						this, {
							fieldLabel : '计划状态',
							valueField : 'planStatus',
							hiddenName : 'planStatus',
...
/**
 * 生产计划状态(1自制生产计划，2外购/外协生产计划)
 */
Ext.ffc.ProductionPlanCategoryComboBox = Ext.extend(Ext.form.ComboBox, {
			store : null,
			constructor : function(_cfg) {
				if (_cfg == null) {
					_cfg = {};
				...
				this.store = new Ext.data.SimpleStore({
							...
							data : [[-1, '全部'], [1, '自制生产计划'], [2, '外购/外协生产计划']]
						});
				Ext.ffc.ProductionPlanCategoryComboBox.superclass.constructor.call(
						this, {
							fieldLabel : '计划种类',
							valueField : 'planType',
							hiddenName : 'planType',
