 ...
 */
Ext.zhj.quoDetail.WorkOrderList = Ext.extend(Ext.grid.GridPanel, {
	quoId : null,
	...
	constructor : function(_cfg) {
		...
		ds.on("datachanged", function() {
			...
			for (var i = 0; i < count; i++) {
				...
				var _proTree = Ext.zhj.quoDetail.GetNewTree(oldRecord.get('id'), oldRecord.get('id'));
		...
		Ext.zhj.quoDetail.WorkOrderList.superclass.constructor.call(this, {
			bodyStyle : 'width:100%',
			height : 250,
			enableHdMenu : false,
			border : false,
 ...
 */
Ext.zhj.quoDetail.WorkOrderProductTapPanel = Ext.extend(Ext.TabPanel, {
	constructor : function(_cfg) {
		if (_cfg == null) {
			_cfg = {};
		}
		Ext.apply(this, _cfg);
		Ext.zhj.quoDetail.WorkOrderProductTapPanel.superclass.constructor
				.call(this, {
 ...
 * @extends Ext.Window
 */
Ext.zhj.QuoInfoDetailWindow = Ext.extend(Ext.Window, {
	quoId : null,
	simpleForm : null,
	workOrderList : null,
