	...
	var qOSupplierGrid = Ext.extend(Ext.grid.GridPanel,{
		store:null,
		constructor : function(_cfg){
			...
			qOSupplierGrid.superclass.constructor.call(this, {
				height:520,
				store: this.store,
				columns: [
...
var  qOSupplierSelectForm = Ext.extend(Ext.FormPanel, {
	constructor : function(_cfg) {
		if(_cfg == null) {
			_cfg = {};
		}
		Ext.apply(this, _cfg);
		qOSupplierSelectForm.superclass.constructor.call(this, {
	...
	var qOSupplierWin = Ext.extend(Ext.Window,{
		supplier_grid:null,
		quotationCode:null,
		customerCode:null,
		customerName:null,
		...
		constructor : function(_cfg){
			...
			Ext.apply(this, _cfg);
			this.flag = false;
			this.selectForm2 = new qOSupplierSelectForm();
			this.supplier_grid = new qOSupplierGrid();
...
//				win.show();
			...
			qOSupplierWin.superclass.constructor.call(this, {
...
//							var win = new  Ext.ls.scheduleOrder.addWin({node:this.node,quotationId:this.quotationId,quotationCode:this.quotationCode,supplierId:record.get('id')});
