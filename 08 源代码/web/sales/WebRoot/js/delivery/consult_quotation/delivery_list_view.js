...
var  selectForm3 = new Ext.FormPanel({
                        ...
                        items:[
                            ...
                            items:[
							    ...
							    {columnWidth:0.25,items: [{xtype:'textfield',fieldLabel: '报价单编号',name: 'quotationCode',anchor:'70%'}]},	
								{columnWidth:0.15,items: [new Ext.ffc.DeliveryStatusComboBox({anchor:'90%'})]},        
		...
		tbar:[{
					...
					'click' : function() {
						Ext.ffc.select_quotations('3','6',function(arr,select_quotations_win){
							...
							if(cusLockStatus * 1 == 0){
								Ext.Msg.alert("消息", "所选中预定报价单,所属客户已经锁定,不允许交货!");
								return ;
							}
							//alert(quotationId);
				...
				listeners : {
					'click' : function(obj) {
						...
						window.open(PATH + "/delivery/outExcelAction.do?ffc=expertList2Excel&deliveryType=1&" + para.join("&"));
					}
				}
        	}
		]
