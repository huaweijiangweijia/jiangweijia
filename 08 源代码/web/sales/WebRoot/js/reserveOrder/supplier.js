	...
	var suppliGrid = Ext.extend(Ext.grid.GridPanel,{
		store:null,
		constructor : function(_cfg){
			...
			suppliGrid.superclass.constructor.call(this, {
				height:500,
				store: this.store,
				columns: [
...
var  rSupplierSelectForm = Ext.extend(Ext.FormPanel, {
	constructor : function(_cfg) {
		if(_cfg == null) {
			_cfg = {};
		}
		Ext.apply(this, _cfg);
		rSupplierSelectForm.superclass.constructor.call(this, {
	...
	var supplierWin = Ext.extend(Ext.Window,{
		selectForm2:null,
		supplier_grid:null,
		constructor : function(_cfg){
			if(_cfg == null) {
			...
			Ext.apply(this, _cfg);
			this.selectForm2 = new rSupplierSelectForm();
			this.supplier_grid = new suppliGrid();
			this.supplier_grid.on('rowdblclick',function(grid,rowIndex,e)
			{
				...
				var win = new Ext.ls.reserveOrder.addWin(addParam);
			...
			supplierWin.superclass.constructor.call(this, {
