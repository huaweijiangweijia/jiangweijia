...
Ext.ux.SwfUploadPanel = Ext.extend(Ext.grid.GridPanel, {
    ...
    strings: {
        ...
        text_cancel: '取消上传',
        text_clear: '清空上传队列',
        text_progressbar: '上传状态',
        text_remove: '删除文件',
        text_remove_sure: '确定从上传队列中删除该文件吗?',
        text_error: '错误信息',
        ...
        error_size_exceeded: '所选择的文件超过了系统允许的大小 {0}.',
...
//            width: this.width - 7
        ...
        this.on('bodyresize', function() {
            ...
            this.suo = new SWFUpload({
                ...
                //post_params: { PHPSESSIDX: '99aff71b349644c2cf845e65c29d204c' },
    ...
    resizeProgressBar: function() {
		//Ext.ffc.util.debugWin(Ext.Button.superclass.initComponent);
        this.progress_bar.setWidth(this.getBottomToolbar().el.getWidth() - 5);
        Ext.fly(this.progress_bar.el.el.dom.firstChild.firstChild).applyStyles("height: 16px");
    },
