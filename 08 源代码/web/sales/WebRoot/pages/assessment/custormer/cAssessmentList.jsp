...
<div id="searchCustomerAssessment"></div>
<div id="customerAssessmentViewPort"></div>
<div id="customerAssessmentGird"></div>
...
<script type="text/javascript" src="<%=path%>/js/assessment/customer/customerAssessmentList.js?r=1423308686433"></script>
