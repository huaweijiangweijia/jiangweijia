...
<div id="searchSupplierAssessment"></div>
<div id="supplierAssessmentViewPort"></div>
<div id="supplierAssessmentGird"></div>
...
<script type="text/javascript" src="<%=path%>/js/assessment/supplier/supplierAssessmentList.js?r=1423308686433"></script>
