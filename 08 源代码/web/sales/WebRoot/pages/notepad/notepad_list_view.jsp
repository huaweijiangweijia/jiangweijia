...
%>
<script type="text/javascript" src="<%=path%>/js/notepad/notepad_list_view.js?r=1423308686433"></script>
...
var gridCheckSele = new Ext.grid.CheckboxSelectionModel();
    ...
    var grid = new Ext.grid.GridPanel({
        ...
        columns: [
			...
			{header: "附件", width: 75, dataIndex: 'fileCount',
		...
		tbar:[{
				...
				listeners : {
					'click' : function() {
						...
						var data = arr[0].data;
						Ext.ffc.showSlaveFillWindow({id:data.id,busType:12});
					}
				}
        	}
		]
