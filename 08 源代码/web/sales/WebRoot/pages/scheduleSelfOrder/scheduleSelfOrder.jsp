...
<script type="text/javascript" src="<%=path %>/js/scheduleSelfOrder/scheduleSelfOrderDetail.js?r=1423308686433"></script>
<script type="text/javascript" src="<%=path %>/js/scheduleSelfOrder/product.js?r=1423308686433"></script>
<script type="text/javascript" src="<%=path %>/js/scheduleSelfOrder/updateScheduleSelfOrder.js?r=1423308686433"></script>
<script type="text/javascript" src="<%=path %>/js/scheduleSelfOrder/addScheduleSelfOrder.js?r=1423308686433"></script>
<script type="text/javascript" src="<%=path %>/js/scheduleSelfOrder/supplier.js?r=1423308686433"></script>
<script type="text/javascript" src="<%=path %>/js/scheduleSelfOrder/quotation.js?r=1423308686433"></script>
<script type="text/javascript" src="<%=path %>/js/scheduleSelfOrder/scheduleSelfOrder.js?r=1423308686433"></script>
<script type="text/javascript" src="<%=path%>/js/reserve_plan/reserve_plan_edit_win.js?r=1423308686433"></script>
