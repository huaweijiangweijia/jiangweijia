...
<script type="text/javascript" 	src="<%=path%>/js/baseInfo/accountsInfoDetailWindow.js?r=1423308686433"></script>
<!-- 公司信息列表 -->
<script type="text/javascript" 	src="<%=path%>/js/baseInfo/reserveList.js?r=1423308686433"></script>
