...
<div id="productSortViewPort"></div>
<div id="productSortGird"></div>

<script type="text/javascript" 	src="<%=path%>/js/baseInfo/productCorrelation/productSortList.js?r=1423308686433"></script>
