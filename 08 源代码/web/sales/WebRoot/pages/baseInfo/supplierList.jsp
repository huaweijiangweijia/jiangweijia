...
<script type="text/javascript" 	src="<%=path%>/js/baseInfo/supplierBrankDetailWindow.js?r=1423308686433"></script>
<!-- 供应商信息列表 -->
<script type="text/javascript" 	src="<%=path%>/js/baseInfo/supplierList.js?r=1423308686433"></script>
