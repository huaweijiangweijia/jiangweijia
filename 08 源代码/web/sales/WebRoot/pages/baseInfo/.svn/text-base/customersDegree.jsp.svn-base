...
<script type="text/javascript" 	src="<%=path%>/js/baseInfo/cusDegRebDetailWindow.js"></script>
<!-- 客户等级信息维护 -->
<script type="text/javascript" 	src="<%=path%>/js/baseInfo/customersDegree.js"></script>
