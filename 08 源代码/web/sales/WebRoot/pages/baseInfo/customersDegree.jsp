...
<div id="degreeRebateGrid"></div>
<div id="customersDegreeViewPort"></div>
<div id="customersDegreeGrid"></div>

<script type="text/javascript" 	src="<%=path%>/js/baseInfo/cusDegRebDetailWindow.js?r=1423308686433"></script>
<!-- 客户等级信息维护 -->
<script type="text/javascript" 	src="<%=path%>/js/baseInfo/customersDegree.js?r=1423308686433"></script>
