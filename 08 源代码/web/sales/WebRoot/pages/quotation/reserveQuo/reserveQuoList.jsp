...
var _editerName = LoginInfor.user.trueName;
	...
	<script type="text/javascript" src="<%=path %>/js/quotation/reserveQuo/ExportReserveQuo.js?r=1423308686433"></script>
	<script type="text/javascript" src="<%=path %>/js/quotation/reserveQuo/reserveQuo_index.js?r=1423308686433"></script>