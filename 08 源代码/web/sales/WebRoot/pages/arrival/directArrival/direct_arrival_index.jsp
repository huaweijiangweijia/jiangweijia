...
<div id="direct_arrival_index"></div>
<script type="text/javascript" src="<%=path%>/js/quotation/generalQuo/statusCombox.js?r=1423308686433"></script>
<script type="text/javascript" src="<%=path %>/js/arrival/directArrival/direct_arrival_manage.js?r=1423308686433"></script>
<script type="text/javascript" src="<%=path %>/js/arrival/order_search.js?r=1423308686433"></script>
<script type="text/javascript" src="<%=path %>/js/arrival/directArrival/direct_arrival_index.js?r=1423308686433"></script>
