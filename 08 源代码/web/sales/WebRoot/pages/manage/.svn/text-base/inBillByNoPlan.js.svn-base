firebow.logistics.InBillByNoPlanPanel = Ext.extend(Ext.Panel, {
	inBill_detail : null,
	dept : "",
	tpanel : null,
	constructor : function(_cfg) {
		...
		companyCombo.store.load();

		// 直进直拨

		var repoCombo_move = new Ext.form.ComboBox({
			store : new Ext.data.JsonStore({
				root : "root",
				proxy : new Ext.data.HttpProxy({
		...
		firebow.logistics.InBillByNoPlanPanel.superclass.constructor.call(this,
				f_config);
	},

	// 初始化事件
	initEvents : function() {
		firebow.logistics.InBillByNoPlanPanel.superclass.initEvents.call(this);
	...
	aftershow : function() {
		firebow.logistics.InBillByNoPlanPanel.superclass.onShow.call(this);
