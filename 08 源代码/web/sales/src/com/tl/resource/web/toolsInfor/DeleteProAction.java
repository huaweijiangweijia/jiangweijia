...
public class DeleteProAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		// 构造JSON对象
		try {
			proToolsInforService.deleteProductTools(id);
			// JSONObject jsonObj = JSONObject.fromObject(json);

			// String id = jsonObj.getString("id");
			// TreeDto treeDto =
			// proToolsInforService.getProductToolsInfoById(id);
			// Map<String, Object> parmMap = new HashMap<String, Object>();
			// parmMap.put("productToolsInforId", id);
			// parmMap.put("product_tool_infor_id", id);
			// int ordPriceCount =
			// productCorrelationService.getOrdePriceCountByToolsId(id);
			// int salPriceCount =
			// productCorrelationService.getSalePriceCountByToolsId(id);
