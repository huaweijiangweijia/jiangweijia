...
import com.tl.resource.business.trySelfOrder.TrySelfOrderService;
import com.tl.resource.dao.pojo.TAuditHistory;
import com.tl.resource.dao.pojo.TOrderInfor;

public class TrySelfOrderAuditImp implements IAuditBusinessObject{
	
	private TrySelfOrderService trySelfOrderService = (TrySelfOrderService) SystemInstance.getInstance().getBean("TrySelfOrderServiceImpl");
	private TAuditHistory abo;
    private LinkBusinessObject bo;
	private String businessType = "017";
	@Override
	public String cancelAudit() {
		// TODO Auto-generated method stub
		return trySelfOrderService.cancelAudit(abo.getBusinessId());
	}

	@Override
	public String endAudit() {
		// TODO Auto-generated method stub
		return trySelfOrderService.endAudit(abo.getBusinessId());
	}
	
	@Override
	public String submitAudit() {
		// TODO Auto-generated method stub
		return trySelfOrderService.submitAudit(abo.getBusinessId());
	}
...
//		list.add(phi8);
	...
	public void loadBo(String id) {
		...
		TOrderInfor vo = trySelfOrderService.getOrderInforById(id);
		bo.setId(vo.getId());
		...
		bo.addProperty("url", "/js/trySelfOrder/trySelfOrderDetail.js");
	}
	...
	public TrySelfOrderService getTrySelfOrderService() {
		return trySelfOrderService;
	}

	public void setTrySelfOrderService(TrySelfOrderService trySelfOrderService) {
		this.trySelfOrderService = trySelfOrderService;
	}
