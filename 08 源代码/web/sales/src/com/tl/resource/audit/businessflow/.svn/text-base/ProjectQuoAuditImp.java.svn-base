 ...
 *
 */
public class ProjectQuoAuditImp implements IAuditBusinessObject ,IAuditContentBusinessObject {
	...
	private String businessType = "002";
	@Override
	...
	public List<TAuditContentDefDto> getBusinessAuditContents(String id) {
		...
		boolean hasNonStand = projectQuoService.validator(id);
		boolean closingAccountModeChange = projectQuoService.isClosingAccountModeChange(id);
