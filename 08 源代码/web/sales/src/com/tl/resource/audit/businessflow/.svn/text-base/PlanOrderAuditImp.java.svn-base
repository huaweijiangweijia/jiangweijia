...
public class PlanOrderAuditImp  implements IAuditBusinessObject{
	
	private PlanOrderService planOrderService = (PlanOrderService) SystemInstance.getInstance().getBean("PlanOrderServiceImpl");
	private TAuditHistory abo;
    private LinkBusinessObject bo;
	private String businessType = "007";
	@Override
	public String cancelAudit() {
		// TODO Auto-generated method stub
		return planOrderService.cancelAudit(abo.getBusinessId());
	}

	@Override
	public String endAudit() {
		// TODO Auto-generated method stub
		return planOrderService.endAudit(abo.getBusinessId());
	}
	
	@Override
	public String submitAudit() {
		// TODO Auto-generated method stub
		return planOrderService.submitAudit(abo.getBusinessId());
	}
	...
	public void loadBo(String id) {
		...
		TOrderInfor vo = planOrderService.getOrderInforById(id);
		bo.setId(vo.getId());
		...
		bo.addProperty("urgentLevel", vo.getUrgentLevel());
		...
		bo.addProperty("editDate", vo.getEditDate());
		bo.addProperty("userName", vo.getUserName());
		bo.addProperty("url", "/js/planOrder/planOrderDetail.js");
	}
