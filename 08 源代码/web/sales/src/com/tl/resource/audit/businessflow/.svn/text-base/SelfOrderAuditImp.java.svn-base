...
public class SelfOrderAuditImp  implements IAuditBusinessObject{
	
	private SelfOrderService selfOrderService = (SelfOrderService) SystemInstance.getInstance().getBean("SelfOrderServiceImpl");
	private TAuditHistory abo;
    private LinkBusinessObject bo;
	private String businessType = "006";
	@Override
	public String cancelAudit() {
		// TODO Auto-generated method stub
		return selfOrderService.cancelAudit(abo.getBusinessId());
	}

	@Override
	public String endAudit() {
		// TODO Auto-generated method stub
		return selfOrderService.endAudit(abo.getBusinessId());
	}
	
	@Override
	public String submitAudit() {
		// TODO Auto-generated method stub
		return selfOrderService.submitAudit(abo.getBusinessId());
	}
...
//		list.add(phi4);
	...
	public void loadBo(String id) {
		...
		TOrderInfor vo = selfOrderService.getOrderInforById(id);
		bo.setId(vo.getId());
		...
		bo.addProperty("urgentLevel", "1".equals(vo.getUrgentLevel()) ? "紧急" : "一般");
		...
		bo.addProperty("url", "/js/selfOrder/selfOrderDetail.js");
	}
