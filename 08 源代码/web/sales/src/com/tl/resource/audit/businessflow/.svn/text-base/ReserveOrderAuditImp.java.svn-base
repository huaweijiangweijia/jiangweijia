...
public class ReserveOrderAuditImp  implements IAuditBusinessObject{
	...
	private String businessType = "004";
	@Override
	public String cancelAudit() {
		// TODO Auto-generated method stub
		return reserveOrderService.cancelAudit(abo.getBusinessId());
	}

	@Override
	public String endAudit() {
		// TODO Auto-generated method stub
		return reserveOrderService.endAudit(abo.getBusinessId());
	}
	
	@Override
	public String submitAudit() {
		// TODO Auto-generated method stub
		return reserveOrderService.submitAudit(abo.getBusinessId());
	}
	...
	public void loadBo(String id) {
		...
		TOrderInfor vo = reserveOrderService.getOrderInforById(id);
		bo.setId(vo.getId());
		...
		bo.addProperty("url", "/js/reserveOrder/addReserveOrder.js");
	}
