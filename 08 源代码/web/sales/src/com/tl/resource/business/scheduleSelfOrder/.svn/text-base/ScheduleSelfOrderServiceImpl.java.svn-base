...
public class ScheduleSelfOrderServiceImpl implements ScheduleSelfOrderService {
	...
	public List<QuotationDetailForOrderDto> getQuoDetailById(Map<String, Object> parmMap) {
		...
		return quotationProductDetailDAO.getQuoDetailById(parmMap);
	}

	@Override
	public int getQuoDetailCountById(Map<String, Object> parmMap) {
		// TODO Auto-generated method stub
		return quotationProductDetailDAO.getQuoDetailCountById(parmMap);
	}
	...
	public List<OrderDetialsDto> getQuoDetailBySupplier(
		...
		// TODO Auto-generated method stub
		return quotationProductDetailDAO.getQuoDetailBySupplier(parmMap);
	}

	@Override
	public int getQuoDetailCountBySupplier(Map<String, Object> parmMap) {
		// TODO Auto-generated method stub
		return quotationProductDetailDAO.getQuoDetailCountBySupplier(parmMap);
	}
	...
	public List<OrderDetialsDto> getSSOrderDetailsList(
			Map<String, Object> parmMap) {
		// TODO Auto-generated method stub
		return orderDetailDao.getSSOrderDetailsList(parmMap);
	}

	@Override
	public int getSSOrderDetailsListCount(Map<String, Object> parmMap) {
		// TODO Auto-generated method stub
		return orderDetailDao.getSSOrderDetailsListCount(parmMap);
	}
