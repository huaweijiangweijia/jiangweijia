...
public class File
{
    ...
    public java.io.File saveTempFile(String fileName, String extName, java.io.File filePath) throws SmartUploadException, IOException{
    	try
        {
            java.io.File file = java.io.File.createTempFile(fileName, extName, filePath);
            try
            {
                FileOutputStream fileoutputstream = new FileOutputStream(file);
                fileoutputstream.write(m_parent.m_binArray, m_startData, m_size);
