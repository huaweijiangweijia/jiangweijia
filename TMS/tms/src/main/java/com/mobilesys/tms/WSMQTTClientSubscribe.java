...
public class WSMQTTClientSubscribe {
	private static final Logger LOG = Logger.getLogger(WSMQTTClientSubscribe.class);
	private final static String CONNECTION_STRING = "tcp://localhost:61613";
	private final static boolean CLEAN_START = true;
	private final static short KEEP_ALIVE = 30;// 低耗网络，但是又需要及时获取数据，心跳30s
	private final static String CLIENT_ID = "publishService";
	public static Topic[] topics1 = { new Topic("china_beijing", QoS.EXACTLY_ONCE),
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 创建相关的MQTT 的主题列表
			Topic[] topics = { new Topic("china_beijing", QoS.AT_LEAST_ONCE) };
			// 订阅相关的主题信息
